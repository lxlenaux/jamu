...
## How to install (DEFAULT or BASIC USAGE)
	* git clone https://github.com/lxlenaux/jamu
	* cd jamu
	* unzip node_modules.zip
	* npm install 
	  or npm install https://github.com/dilame/instagram-private-api
	* npm audit fix
	* ls
...
## For PC/Laptop ONLY:
	...
	* Download File on Github (https://github.com/lxlenaux/jamu)
	* Extract File jamu and enter the folder
	* Right Click on Mouse, Then Select "Git Bash Here" (Make sure you are in the jamu folder!!!)
...
## For TERMUX ONLY:
	...
	* unzip node_modules.zip
	* npm install 
	  or npm https://github.com/dilame/instagram-private-api
	* npm audit fix
	* ls
	* Then select the tool you want to use!
	* node filename
